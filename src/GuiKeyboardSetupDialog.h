...
class GuiKeyboardSetupDialog
  : public QDialog
  , private Ui::GuiKeyboardSetupDialog
{
  Q_OBJECT
...
private slots:
  ...
  void on_rightTestButton_released() { m_song->pcKeyPress('x', false); }
  void on_wrongTestButton_pressed()
  {
    m_song->testWrongNoteSound(true);
    m_song->pcKeyPress('x', true);
  }
  void on_wrongTestButton_released() { m_song->pcKeyPress('x', false); }
