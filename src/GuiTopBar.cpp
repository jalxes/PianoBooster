...
void
GuiTopBar::reloadKeyCombo(bool major)
{
  keyCombo->clear();
  if (major) {
...
void
GuiTopBar::on_keyCombo_activated(int index)
{
...
void
GuiTopBar::on_transposeSpin_valueChanged(int value)
{
...
void
GuiTopBar::setPlayButtonState(bool checked, bool atTheEnd)
{
  if (atTheEnd)
...
void
GuiTopBar::on_playButton_clicked(bool clicked)
{
  if (!m_song)
    return;
...
void
GuiTopBar::on_playFromStartButton_clicked(bool clicked)
{
  if (!m_song)
    return;
...
void
GuiTopBar::on_speedSpin_valueChanged(int speed)
{
  if (!m_song)
    return;
...
void
GuiTopBar::on_startBarSpin_valueChanged(double bar)
{
  if (!m_song)
    return;
...
void
GuiTopBar::on_saveBarButton_clicked(bool clicked)
{
  if (!m_song)
    return;
...
void
GuiTopBar::on_loopingBarsPopupButton_clicked(bool clicked)
{
  if (!m_song)
    return;
...
bool
GuiTopBar::eventFilter(QObject* obj, QEvent* event)
{
