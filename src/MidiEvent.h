...
#define MIDI_PB_chordSeparator                                                 \
  0x0ff3 // All the notes (note on) between these counts as one chord
...
#define MIDI_PB_outputRawMidiData                                              \
  0x0ff8 // Raw data is used for used for a SYSTEM_EVENT
...
public:
  ...
  std::string event_type_str(int atype)
  {
    ...
    switch (atype) {
      ...
      case MIDI_NOTE_PRESSURE:
        r = "MIDI_NOTE_PRESSURE";
        break;
      case MIDI_CONTROL_CHANGE:
        r = "MIDI_CONTROL_CHANGE";
        break;
      case MIDI_PROGRAM_CHANGE:
        r = "MIDI_PROGRAM_CHANGE";
        break;
      case MIDI_CHANNEL_PRESSURE:
        r = "MIDI_CHANNEL_PRESSURE";
        break;
      case MIDI_PITCH_BEND:
        r = "MIDI_PITCH_BEND";
        break;
      case MIDI_SYSTEM_EVENT:
        r = "MIDI_SYSTEM_EVENT";
        break;
      case MIDI_SUSTAIN:
        r = "MIDI_SUSTAIN";
      ...
      case MIDI_RESET_ALL_CONTROLLERS:
        r = "MIDI_RESET_ALL_CONTROLLERS";
        break;
      case MIDI_ALL_SOUND_OFF:
        r = "MIDI_ALL_SOUND_OFF";
        break;
      case MIDI_ALL_NOTES_OFF:
        r = "MIDI_ALL_NOTES_OFF";
        break;
      ...
      case MIDI_PB_EOF:
        r = "MIDI_PB_EOF";
        break;
      case MIDI_PB_chordSeparator:
        r = "MIDI_PB_chordSeparator";
        break;
      case MIDI_PB_tempo:
        r = "MIDI_PB_tempo";
        break;
      case MIDI_PB_timeSignature:
        r = "MIDI_PB_timeSignature";
        break;
      case MIDI_PB_keySignature:
        r = "MIDI_PB_keySignature";
        break;
      case MIDI_PB_collateRawMidiData:
        r = "MIDI_PB_collateRawMidiData";
        break;
      case MIDI_PB_outputRawMidiData:
        r = "MIDI_PB_outputRawMidiData";
        break;
  ...
  void printDetails()
  {
    if (type() == MIDI_NOTE_ON) {
      ppTiming(
        "chan %2d NOTE ON  note %3d vel %3d", channel(), note(), velocity());
    } else if (type() == MIDI_NOTE_OFF) {
      ppTiming(
        "chan %2d NOTE OFF note %3d vel %3d", channel(), note(), velocity());
    } else {
      ppTiming("chan %2d type %-20s note %3d velocity %3d deltaTime %3d",
               channel(),
               event_type_str(type()).c_str(),
               note(),
               velocity(),
               deltaTime());
    }
