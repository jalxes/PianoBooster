...
public:
  ...
  bool displayCourtesyAccidentals()
  {
    return CNotation::displayCourtesyAccidentals();
  }
  ...
  /// returns true if the user wants to see the note names
  bool showNoteNames() { return m_noteNamesEnabled; }

  /// returns true if the user wants to see color-coded notes
  bool coloredNotes() { return m_coloredNotes; }

  void coloredNotes(bool b) { m_coloredNotes = b; }

  /// returns true if the user wants Follow Skill to ignore errors
  bool followThroughErrors() { return m_followThroughErrorsEnabled; }
  ...
  QStringList getFluidSoundFontNames() { return m_fluidSoundFontNames; }
...
private:
  Q_OBJECT
  QDomElement openDomElement(QDomElement parent,
