...
void
CStavePos::notePos(whichPart_t hand, int midiNote)
{
  ...
  m_staveIndex +=
    (midiNote / semitonesInAnOctive) * notesInAnOctive - notesInAnOctive * 5;
  m_accidental = lookUpItem->accidental;
  // ppLogTrace("chan %d Note %2d - %2d (%d %d %d),\n", midiNote, m_staveIndex,
  // m_accidental, index%semitonesInAnOctive, lookUpItem->pianoNote,
  // (midiNote/semitonesInAnOctive)*notesInAnOctive);
}

// convert the midi note to the note name C=1, D=2, E=3, F=4, G=5, A=6, B=7
staveLookup_t
CStavePos::midiNote2Name(int midiNote)
{
  const staveLookup_t* staffLookupC =
    getstaveLookupTable(0); // Key of C so we get all the not names
...
void
CStavePos::setKeySignature(int key, int majorMinor)
{
  m_KeySignature = key;
...
const staveLookup_t*
CStavePos::getstaveLookupTable(int key)
{
  const staveLookup_t* staveLookup;

  static const staveLookup_t staffLookupFlat6[] = {
  ...
  static const staveLookup_t staffLookupFlat5[] = {
    // Db [Bb Eb Ab Db Gb]
    { 1, 0 }, //.C
    { 2, 0 }, //-Db
    { 2, 2 }, // Dn
  ...
  static const staveLookup_t staffLookupFlat4[] = {
    // Ab [Bb Eb Ab Db]
    { 1, 0 },  //.C
    { 2, 0 },  //.Db
    { 2, 2 },  // Dn
  ...
  static const staveLookup_t staffLookupFlat3[] = {
    // Eb [Bb Eb Ab]
    { 1, 0 },  //.C
    { 2, -1 }, // Db
    { 2, 0 },  //.D
  ...
  static const staveLookup_t staffLookupFlat2[] = {
    // Bb [Bb Eb]
    { 1, 0 },  //.C
    { 2, -1 }, // Db
    { 2, 0 },  //.D
  ...
  static const staveLookup_t staffLookupFlat1[] = {
    // F [Bb]
    { 1, 0 },  //.C
    { 1, 1 },  // C# (Db)
    { 2, 0 },  //.D
  ...
  static const staveLookup_t staffLookupSharp1[] = {
    // G [F#]
    { 1, 0 },  //.C
    { 1, 1 },  // C#
    { 2, 0 },  //.D
  ...
  static const staveLookup_t staffLookupSharp2[] = {
    // D [F# C#]
    { 1, -2 }, // Cn
    { 1, 0 },  //.C#
    { 2, 0 },  //-D
  ...
  static const staveLookup_t staffLookupSharp3[] = {
    // A [F# C# G#]
    { 1, -2 }, // Cn
    { 1, 0 },  //.C#
    { 2, 0 },  //.D
  ...
  static const staveLookup_t staffLookupSharp4[] = {
    // E [F# C# G# D#]
    { 1, -2 }, // Cn
    { 1, 0 },  //.C#
    { 2, -2 }, // Dn
  ...
  static const staveLookup_t staffLookupSharp5[] = {
    // B [F# C# G# D# A#]
    { 1, -2 }, // Cn
    { 1, 0 },  //.C#
    { 2, -2 }, // Dn
  ...
  static const staveLookup_t staffLookupSharp6[] = {
    // F# [F# C# G# D# A# E#]
    { 1, -2 }, // Cn
    { 1, 0 },  //.C#
    { 2, -2 }, // Dn
  ...
  switch (key) {
    case -6:
      staveLookup = staffLookupFlat6;
      break;
    case -5:
      staveLookup = staffLookupFlat5;
      break;
    case -4:
      staveLookup = staffLookupFlat4;
      break;
    case -3:
      staveLookup = staffLookupFlat3;
      break;
    case -2:
      staveLookup = staffLookupFlat2;
      break;
    case -1:
      staveLookup = staffLookupFlat1;
      break;
    case 0:
      staveLookup = staffLookupC;
      break;
    case 1:
      staveLookup = staffLookupSharp1;
      break;
    case 2:
      staveLookup = staffLookupSharp2;
      break;
    case 3:
      staveLookup = staffLookupSharp3;
      break;
    case 4:
      staveLookup = staffLookupSharp4;
      break;
    case 5:
      staveLookup = staffLookupSharp5;
      break;
    case 6:
      staveLookup = staffLookupSharp6;
      break;
    default:
      staveLookup = staffLookupC;
      break;
